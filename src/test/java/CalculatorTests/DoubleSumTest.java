...
public class DoubleSumTest extends CalculatorTestBase {
    private final String GENERAL_TEST_TITLE = "Sum of double: ";
    ...
    Function<Object[], ?> getNegativeFunction() {
        return input -> calculator.sum(Double.parseDouble(input[0].toString()), Double.parseDouble(input[1].toString()));
    }
    ...
    public void testDoubleSumNegative(Object a, Object b, Class<? extends Throwable> expectedException) {
